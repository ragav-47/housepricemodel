...
## OUTPUT:
![output](./static/img/HouseModelPrediction.png)
...
## RESULT:
Thus a website is designed to train the house price model and to predict the price and is hosted in the URL http://ragav.student.saveetha.in:8000/HouseModelPrediction/ and http://ragav.student.saveetha.in:8000/HouseModelTraining/ HTML code is validated.